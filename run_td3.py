...
policy_network_architecture = (
    [observation_size] + policy_network_architecture + [action_size]
)
...
q_function_network_architecture = (
    [observation_size + action_size] + q_function_network_architecture + [1]
)
q_function_1_network: nn.Module = MLP(
    sizes=q_function_network_architecture, activation_function=nn.ReLU
)
